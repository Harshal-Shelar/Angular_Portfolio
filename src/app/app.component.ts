...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle("Harshal Shelar | MEAN Stack Developer | Angular Developer | Software Engineer");
    this.metaService.addTags([
      { name: 'keywords', content: 'Frontend, MEAN Stack Developer , Angular Development , Software Engineer, software, developer' },
